        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_desc_Incidence = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentType_Contact_ContactId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    varchar = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_State = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DetailIncidenceId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_State_DetailIncidence_DetailIncidenceId",
                        column: x => x.DetailIncidenceId,
                        principalTable: "DetailIncidence",
                        principalColumn: "Id_DetailIncidence");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incidence_Place_PlaceId",
                        column: x => x.PlaceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentType_ContactId",
                table: "DocumentType",
                column: "ContactId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_State_DetailIncidenceId",
                table: "State",
                column: "DetailIncidenceId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AreaUser_Person_Id_Person",
                table: "AreaUser",
                column: "Id_Person",
                principalTable: "Person",
                principalColumn: "Id_User",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CategoryContact_Contact_ContactId",
                table: "CategoryContact",
                column: "ContactId",
                principalTable: "Contact",
                principalColumn: "Id_Contact");
